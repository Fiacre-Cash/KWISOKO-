...
-- CreateEnum
CREATE TYPE "SellerStatus" AS ENUM ('PENDING', 'APPROVED', 'REJECTED', 'BANNED');

-- CreateEnum
CREATE TYPE "ProductStatus" AS ENUM ('DRAFT', 'ACTIVE', 'SOLD', 'REMOVED');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('ORDER', 'MESSAGE', 'REVIEW', 'SYSTEM', 'PAYMENT');

-- CreateEnum
CREATE TYPE "ReportReason" AS ENUM ('SCAM', 'FAKE_PRODUCT', 'INAPPROPRIATE', 'SPAM', 'OTHER');
...
CREATE TABLE "orders" (
    ...
    "totalRwf" DOUBLE PRECISION NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "chats_sellerId_buyerId_key" ON "chats"("sellerId", "buyerId");
...
-- AddForeignKey
ALTER TABLE "chats" ADD CONSTRAINT "chats_sellerId_fkey" FOREIGN KEY ("sellerId") REFERENCES "sellers"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
